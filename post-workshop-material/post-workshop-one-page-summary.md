...
Use this summary after the workshop to keep momentum and turn candidate automation ideas into evidence-based opportunities.

---

## What we covered

The workshop introduced a simple approach:
...
7. Decide whether to automate, improve first, investigate further or defer.
...
You do not need every metric. Choose the measures that best explain the pain and value.

| Metric group | Useful questions |
|---|---|
| **Effort** | How often does this happen? How much human effort is involved? Where is repetitive or low-value work happening? |
| **Flow** | How long does the process take end to end? Where does work wait? Where are the handoffs? What systems are touched? |
| **Quality & risk** | How often does work need correcting? How often are there exceptions? What happens if something goes wrong? Who experiences the pain? |

Remember the time distinction:

| Type of time | Meaning |
|---|---|
| **Cycle time** | Total elapsed time from start to finish |
| **Touch time** | Actual human effort |
| **Wait time** | Time sitting idle between steps |

A slow process is not always an effort-heavy process.

---

## Decide the likely response

Automation is one possible response, but not the only one.
...
| Lens | Key question |
|---|---|
| **Value** | Is this worth solving? |
| **Feasibility** | Can we automate it? |
| **Readiness** | Is the process ready? |

A good automation candidate is not just technically possible. It should be valuable, feasible and ready.
...
- [ ] Identify quick wins.
- [ ] Identify process improvements needed before automation.
- [ ] Identify opportunities that need technical feasibility assessment.
...
| `scenario-clinic-capture.md` | Capture follow-up scenario discussions |
| `automation-opportunity-assessment.md` | Assess value, feasibility and readiness |
| `opportunity-backlog.md` | Track opportunities, owners and next actions |
